...
<body>
    ...
    <div id="whole-main">
        ...
        <div id="summary-details">
            ...
            <div id="btn">
                <button class="stripe-button" id="btnPayment">
    ...
    <script>
        ...
        function showOnBtn() {
            ...
            document.getElementById('btnPayment').style.opacity = '1';
            btnReserve.style.opacity = '1';
            document.getElementById('btnPayment').style.pointerEvents = "all";
        ...
        function hideOnBtn() {
            ...
            document.getElementById('btnPayment').style.opacity = '0';
        ...
        var stripe = Stripe('<?php echo PUB_KEY ?>');
